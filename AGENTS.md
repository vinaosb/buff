...
- **See per-crate `AGENTS.md`** in every `crates/buff-{lang-*,lsp,eval,repl,jupyter,registry,playground-wasm,ui-dioxus}/` and `tests/AGENTS.md` + `tree-sitter-buff/AGENTS.md` + `editors/vscode/AGENTS.md` + `examples/AGENTS.md` + `.sisyphus/AGENTS.md` + `docs/AGENTS.md` + `book/AGENTS.md` for detailed file-level guidance.
