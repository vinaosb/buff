# Deox Language — Master Orchestrator Plan
...
> **Deox** (Deoxidizer) — a high-level language that transpiles to Rust, with automatic CPU/GPU parallelism, native async (Tokio), and Go/C#-like simplicity. Written in Rust (dogfooding). Delivers Rust performance without the borrow-checker pain via intelligent clone+move semantics.
>
> **Total scope**: ~111 tasks + 4 final verification across 3 phases
> (Phase 1: 20 tasks, Phase 2: 47 tasks, Phase 3: 44 active + 3 deferred)
>
> **Phase Files**:
> - **Phase 1**: [`.sisyphus/plans/deox-v01-mvp.md`](./deox-v01-mvp.md) — "Olá Deox" MVP (Tasks 1-17, T33a, T88, T110)
> - **Phase 2**: [`.sisyphus/plans/deox-v05-language.md`](./deox-v05-language.md) — Complete Language (Tasks 18-37 + enhancements T67-T112)
> - **Phase 3**: [`.sisyphus/plans/deox-v10-production.md`](./deox-v10-production.md) — Heterogeneous Computing (Tasks 38-66 + enhancements T80-T113)
> - **Reference**: [`.sisyphus/plans/deox-numeric-system.md`](./deox-numeric-system.md) — Complete numeric type specification
> - **Reference**: [`.sisyphus/plans/deox-project-structure.md`](./deox-project-structure.md) — Project layout standard (deox.toml, templates, workspaces)
> - **Reference**: [`.sisyphus/plans/deox-conventions.md`](./deox-conventions.md) — 18 coding conventions (naming, formatting, docs, errors, testing, APIs)
...
### Architecture
- **Transpiler pipeline**: `.deox` source → Lexer (logos) → Parser (chumsky) → Type Checker → Rust Codegen (syn/quote/prettyplease) → rustc/LLVM → native binary
- **Cargo workspace**: 9 crates (`deox-ast`, `deox-lexer`, `deox-parser`, `deox-types`, `deox-codegen-rust`, `deox-codegen-wgsl`, `deox-runtime`, `deox-cli`, `deox-error`)
...
### Numeric Type System (See `deox-numeric-system.md` for full spec)
...
### Phase 1: v0.1 "Olá Deox" — MVP Foundation
...
**File**: [`deox-v01-mvp.md`](./deox-v01-mvp.md)
...
**File**: [`deox-v05-language.md`](./deox-v05-language.md)
...
**File**: [`deox-v10-production.md`](./deox-v10-production.md)
