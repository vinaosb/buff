...
//!
//! Every `let` binding emitted by `deox-codegen-rust` now carries an
//! explicit Rust type annotation. When the Deox source provides one
...
//    `let z: rust_decimal::Decimal = ...`. (Deox v0.1 has no Decimal
