//! Local type inference for the Deox language (v0.1).
//!
...
use deox_ast::{Block, Expr, Ident, Literal, Stmt, TypeRef, UnaryOp};
use deox_error::{Diagnostic, Span, TypeError};
